...
import pandas as pd
import os
from agent.tools.insider_utils import aggregate_insider_sentiment, get_rolling_insider_sentiment

class TestInsiderUtils(unittest.TestCase):

    @patch('agent.tools.insider_utils.pd.read_parquet')
    @patch('agent.tools.insider_utils.os.path.exists')
