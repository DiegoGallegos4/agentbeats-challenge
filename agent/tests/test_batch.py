...
import os
import shutil
from agent.tools.batch_downloader import (
    download_all_sp500,
    download_all_sp500_options,
    download_all_sp500_insider_transactions,
)
...
class TestBatchDownloader(unittest.TestCase):
    ...
    @patch('agent.tools.batch_downloader.time.sleep')
    @patch('agent.tools.batch_downloader.get_daily_data')
    @patch('agent.tools.batch_downloader.get_sp500_tickers')
    ...
    @patch('agent.tools.batch_downloader.time.sleep')
    @patch('agent.tools.batch_downloader.get_options_data')
    @patch('agent.tools.batch_downloader.get_sp500_tickers')
    @patch('agent.tools.batch_downloader.random.uniform')
    ...
    @patch('agent.tools.batch_downloader.get_options_data')
    @patch('agent.tools.batch_downloader.get_sp500_tickers')
    @patch('agent.tools.batch_downloader.os.path.exists')
    @patch('agent.tools.batch_downloader.os.makedirs')
    @patch('agent.tools.batch_downloader.random.uniform')
    ...
    @patch('agent.tools.batch_downloader.time.sleep')
    @patch('agent.tools.batch_downloader.get_insider_transactions')
    @patch('agent.tools.batch_downloader.get_sp500_tickers')
    @patch('agent.tools.batch_downloader.random.uniform')
