...
from unittest.mock import patch, MagicMock
from unittest.mock import patch, MagicMock
from alpha_vantage_downloader import get_daily_data, get_analyst_data, get_earnings_data, get_news_sentiment, get_options_data
import os

class TestAlphaVantageDownloader(unittest.TestCase):

    @patch('alpha_vantage_downloader.requests.get')
